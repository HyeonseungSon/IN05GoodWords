package com.hyeonseungson.in05goodwords

import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import android.widget.ListView
import com.hyeonseungson.goodwords.R
...
class SentenceActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // 위의 String 요소를 넣은 Adapter 생성
        val sentenceAdapter = ListViewAdapter(sentenceList)

        // activity_sentence.xml 의 ListView 에 id 값을 통해 접근합니다.
        val listview = findViewById<ListView>(R.id.sentenceListView)

        // 접근한 ListView 에 Adapter 를 통해 위의 String 요소들을 넣은 sentenceAdapter 를 연결합니다.
